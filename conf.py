...
REDIRECTIONS = [('about-the-author/index.html', '/pages/about-me/index.html'),
                ('publications/index.html', '/pages/publications/index.html'),
                ('about/index.html', '/pages/about/index.html')]
...
# is in the manual.
COMMENT_SYSTEM_ID = "ilovesymposia"
